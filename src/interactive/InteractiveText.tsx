...
import { isDefined, noop, getMouseCanvas, GenericChartComponent } from "../core";
import { HoverTextNearMouse } from "./components/index";
import { getValueFromOverride, isHoverForInteractiveType, saveNodeType, terminate } from "./utils";
import { EachText } from "./wrapper/index";
...
interface InteractiveTextProps {
    ...
    readonly hoverText: object; // eslint-disable-line
